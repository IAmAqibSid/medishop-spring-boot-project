...
import com.jsp.medishop.impl.CustomerDaoImpl;
...
public class CustomerServiceImpl implements CustomerService 
{
	...
	@Autowired
	private EmailPasswordVerification emailPasswordVerification;;
	

	@Override
	public ResponseStructure<Customer> saveCustomerService(Customer customer)
	{
		String email = emailPasswordVerification.verifyEmail(customer.getEmail());
		String password = emailPasswordVerification.verifyPassword(customer.getPassword());
	...
	@Override
	public ResponseStructure<Customer> getCustpmerByEmailService(String customerEmail) 
	{
		return null;
	}
